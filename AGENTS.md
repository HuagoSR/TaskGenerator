...
1. `项目概要.md` — the only project-level source of truth for current status, phase conclusions, bottlenecks, and the A–D roadmap.
...
- E. Second-domain vertical slice — next.
