...
R10 Scenario-First remains the active research boundary. R10.0–R10.7 established public Work Seeds, professional rules, narrative Scenario Bibles, agent-native professional Skills, derived evidence bundles, four statically admitted tasks and a four-task behavioral pilot. R10.8 corrected one teacher anchor, diagnosed low separation, and closed as `evaluator_revision_required`. R10.9 then completed a World-First / Task-Mining experiment: four new matched worlds/tasks passed static admission, truth audit and three-tier Judge calibration, and both solvers produced 8/8 valid deliveries. All four formal paired reviews were nevertheless `judge_ambiguous` because the two Judges disagreed on preference or major-error boundaries. R10.9 therefore also closed as `evaluator_revision_required`. Do not expand to ten tasks, promote candidate difficulty guidance, or rerun frozen tasks/answers/ratings until evaluator stability for nuanced occupational judgments is addressed.
