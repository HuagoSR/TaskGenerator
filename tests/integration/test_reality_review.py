...
from task_generator.core.external_model_policy import (
    ...
    def test_format_failure_gets_one_governed_retry_and_preserves_first_failure(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            def candidate(executor, payload, *, format_feedback=None):
                from task_generator.evaluation.validity_utility import CandidateBlindRealityReviewV2 as RuntimeCandidateReview, RealityReviewDimensionV2 as RuntimeDimension
            ...
            def rubric(executor, payload, *, format_feedback=None):
                from task_generator.evaluation.validity_utility import RubricFocusRealityReviewV2 as RuntimeRubricReview, RealityReviewDimensionV2 as RuntimeDimension
                executor.last_diagnostics = {"prompt_tokens": 100, "completion_tokens": 50, "duration_seconds": 1.0}
                executor.last_raw_response_content = "{}"
            ...
            with patch.object(campaign, "_candidate_payload", side_effect=lambda case_id: {"case_id": case_id}), \
                 ...
                 patch("task_generator.evaluation.semantic_review.SemanticReviewExecutor.review_reality_candidate_blind", new=candidate), \
                 patch("task_generator.evaluation.semantic_review.SemanticReviewExecutor.review_reality_rubric_focus", new=rubric):
