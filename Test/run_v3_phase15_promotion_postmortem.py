...
DEFAULT_EXTERNAL_IMPORT = PHASE15 / "external_eval_import" / "phase15_external_eval_import_report.json"
...
def main() -> None:
    ...
    parser.add_argument("--external-eval-import-report-path", type=Path, default=DEFAULT_EXTERNAL_IMPORT)
