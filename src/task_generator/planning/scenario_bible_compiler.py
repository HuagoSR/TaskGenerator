...
class OfficialDeepSeekScenarioBibleCompiler:
    ...
    def _messages(payload: dict[str, Any]) -> list[dict[str, str]]:
        ...
        system += "\n\nOVERRIDE THE GENERAL RANGE: produce exactly 14 facts: 1 organization, 1 role, 1 transaction, 6 normal_background, 1 anomaly, 1 open_issue, 1 policy_application, 1 consequence, and 1 treatment."
