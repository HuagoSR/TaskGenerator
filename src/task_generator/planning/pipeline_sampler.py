...
from task_generator.planning.motif_graph_grammar import (
    MotifGraphGrammarArtifact,
    MotifGraphGrammarRecord,
    MotifRoleDefinition,
)
from task_generator.generation.pipeline_prototype import DEFAULT_MOTIF_PRIORITY, RESOURCE_ALIASES
from task_generator.substrate.skill_registry import SkillRegistryBuilder
from task_generator.core.source_schema import SemanticResource, SkillRegistryEntry, load_json_file
